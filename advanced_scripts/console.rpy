...
label updateconsolefront(text="", history="", reducetime=0):
    show console_bg zorder 100 onlayer front
    show console_caret zorder 100 onlayer front
    show console_text "_" as ctext zorder 100 onlayer front
    show console_text "[text]" as ctext zorder 100 onlayer front
    $ pause(len(text) / 30.0 + 0.5 - reducetime )
    hide ctext
    show console_text "_" as ctext zorder 100 onlayer front
    call updateconsolehistoryfront(history) from _call_updateconsolehistoryfront
    pause 0.5
    return
label updateconsolehistoryfront(text=""):
    if text:
        python:
        ...
        show console_history "[consolehistorydisplay]" as chistory zorder 100 onlayer front
    return
label hideconsolefront:
    hide console_bg onlayer front
    hide console_caret onlayer front
    hide ctext onlayer front
    hide chistory onlayer front
    return
