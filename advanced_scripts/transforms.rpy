...
define wiperound = ImageDissolve("mod_assets/gui/wiperound.png", 0.66, ramplen=64)
define wiperound_scene = MultipleTransition([
    False, ImageDissolve("mod_assets/gui/wiperound.png", 0.66, ramplen=64),
    Solid("#000"), Pause(0.25),
    Solid("#000"), ImageDissolve("mod_assets/gui/wiperound.png", 0.66, ramplen=64),
    True])
...
define ZAWARUDO = ImageDissolve("mod_assets/gui/zawarudo_wipe.png", 1, ramplen=2)
define ZAWARUDO2 = ImageDissolve("mod_assets/gui/zawarudo_wipe.png", 0.5, ramplen=2, reverse=True)
