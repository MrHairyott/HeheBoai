...
define config.name = "Sans in DDLC"
...
define config.save_directory = "SANS_DDLC"


define config.window_icon = "mod_assets/icon.png"
...
init python:
    renpy.music.register_channel("sound2", mixer="sound", loop=False, stop_on_mute=True, tight=False, file_prefix='', file_suffix='', buffer_queue=True, movie=False)
